	...
	//the same pattern is followed for setting up ambientRooms
		...
		declareAmbientRoom( "outside" );
 		...
 		declareAmbientRoom( "cave_room" );
 			...
 			setAmbientRoomSnapshot ("cave_room", "pow_no_ext_amb");
 		...
 		declareAmbientRoom( "cave_ext_room" );
 			...
 			setAmbientRoomSnapshot ("cave_ext_room", "pow_low_ext_amb");
 		...
 		declareAmbientRoom( "cave_office" );
 			...
 			setAmbientRoomSnapshot ("cave_office", "pow_no_ext_amb");
 		...
 		declareAmbientRoom( "cell_room" );
 			...
 			setAmbientRoomSnapshot ("cell_room", "pow_no_ext_amb");
 		...
 		declareAmbientRoom( "tunnels_medium_room" );
 			...
 			setAmbientRoomSnapshot ("tunnels_medium_room", "pow_no_ext_amb");
 		...
 		declareAmbientRoom( "tunnels_medium_ext_room" );
 			...
 			setAmbientRoomSnapshot ("tunnels_medium_ext_room", "pow_low_ext_amb");
 		 ...
 		 declareAmbientRoom( "tunnels_large_room" );
 			...
 			setAmbientRoomSnapshot ("tunnels_large_room", "pow_no_ext_amb");
 		 ...
 		 declareAmbientRoom( "tunnels" );
 			...
 			setAmbientRoomSnapshot ("tunnels", "pow_no_ext_amb");
...
//	wait(1);
		...
		declareMusicState ("IN_BASE");
			...
			musicStinger ("mus_stings_end_scene", 41, true);
...
low_ext_amb_snapshot()
{
     ...
     snd_set_snapshot( "pow_low_ext_amb" );
}
...
no_ext_amb_snapshot()
{
     ...
     realwait(10.2);
     waitforclient(0);
     snd_set_snapshot( "pow_no_ext_amb" );
     realwait(16);
     waitforclient(0);     
